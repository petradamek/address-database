...
class SimpleAddressFinderWithStreamSearchStrategyTest extends AddressFinderAbstractTest {

    @Override
    protected AddressFinderFactory newAddressFinderFactory(DataLoader dataLoader) {
        return new SimpleAddressFinderFactory(dataLoader, new StreamSearchStrategy());
    }
}