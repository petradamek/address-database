...
class SimpleAddressFinderWithForEachStrategyTest extends AddressFinderAbstractTest {

    @Override
    protected AddressFinderFactory newAddressFinderFactory(DataLoader dataLoader) {
        return new SimpleAddressFinderFactory(dataLoader, new ForEachSearchStrategy());
    }
}